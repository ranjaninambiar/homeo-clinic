...
<body>
    ...
    <!-- ################# Our Team Starts Here#######################--->
      ...
      <div style="margin-top:0px;" class="row no-margin">
        ...
        <iframe  width="100%"  height="450"  style="border:0"  loading="lazy"  allowfullscreen  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB1aqoYxV56best_qj6_oRLfUmSkWzTZVM&q=Amrita+Vishwa+Vidyapeetham"></iframe>
           ...
           <div class="row">
            ...
            <h2>Contact Form</h2>
                <div class="row">
                    ...
                    <div class="col-sm-8"><input id="fname" type="text" required placeholder="Enter Name" name="name" class="form-control input-sm"  ></div>
                </div>
                <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Email Address:</label></div>
                    <div class="col-sm-8"><input id="email" type="text" name="name" required placeholder="Enter Email Address" class="form-control input-sm"  ></div>
                </div>
                 <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Number:</label></div>
                    <div class="col-sm-8"><input id="Contact" type="text" name="name" required placeholder="Enter Mobile Number" class="form-control input-sm"  ></div>
                </div>
                 <div style="margin-top:10px;" class="row">
    ...
    Ettimadai<br>
    Coimbatore<br>
    Email:info@Homeo-Amend.in<br>
    Website:www.Homeo-Amend.com<br>
