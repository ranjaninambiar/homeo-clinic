        ...
        <div class="forms-container">
            <div class="signin-signup">
                <form method="get" action="http://localhost:8080/Homeo/login" class="sign-in-form">
                    ...
                    <div class="social-text"><a href="index.html">Back to Homepage</a></div>
                    
                </form>
                <form method="get" action="http://localhost:8080/Homeo/signup" class="sign-up-form">
                    ...
                    <div class="input-field">
                        ...
                        <input name="email_id" type="email" placeholder="Email" />
                    </div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input name="pwd" type="password" placeholder="Password" />
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input name="cpwd" type="password" placeholder="Confrim Password" />
                    </div>
